...
if (!$InputFile) 
{
	...
	if (-not $DeleteOnly) {
 (new-object System.Net.WebClient).Downloadfile("http://www.ipdeny.com/ipblocks/data/countries/$zone",$InputFile)
 wget http://www.ipdeny.com/ipblocks/data/countries/$zone -OutFile $InputFile
 }
